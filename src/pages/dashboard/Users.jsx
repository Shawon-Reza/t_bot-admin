...
import { FiChevronLeft, FiChevronRight, FiEye, FiRefreshCw, FiSearch, FiShield, FiUserCheck, FiUserX, FiX } from 'react-icons/fi';
...
const Users = () => {
  ...
  const statusMutation = useMutation({
    mutationFn: ({ id, userStatus }) => tUserApi.updateStatus(id, userStatus),
    onSuccess: () => { invalidateUsers(); setViewedUser(null); },
